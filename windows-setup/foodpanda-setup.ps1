...
Write-Host ""
Write-Host "   TO PIN THEM (do this once):" -ForegroundColor White
Write-Host "     Pin the OPEN WINDOW, not the desktop icon (a pinned desktop icon"
Write-Host "     turns into a plain Chrome button):"
Write-Host "       1. Open FoodPanda 1, right-click its TASKBAR button -> Pin to taskbar"
Write-Host "       2. Open FoodPanda 2, right-click its TASKBAR button -> Pin to taskbar"
Write-Host "       3. Drag the pins so 1 sits LEFT of 2  (left = account 1)"
Write-Host ""
