...
const EMPTY = { title: "", description: "", discount_percent: 0, discount_amount: 0, coupon_code: "", image_url: "", active: true };
...
export default function AdminOffers() {
    ...
    const openEdit = (o) => { setEditing(o.id); setForm({ title: o.title, description: o.description, discount_percent: o.discount_percent, discount_amount: o.discount_amount, coupon_code: o.coupon_code, image_url: o.image_url, active: o.active }); };
