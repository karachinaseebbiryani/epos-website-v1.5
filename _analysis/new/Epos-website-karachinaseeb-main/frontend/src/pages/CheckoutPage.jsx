...
import { Phone, MapPin, User, MessageSquare, Tag, Banknote, ArrowLeft, CreditCard, Building2, Smartphone, Store, Navigation, Loader2, UserPlus, UserCheck } from "lucide-react";
            ...
            <form onSubmit={submitOrder} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-5">
                    ...
                    <div className="bg-white border border-neutral-100 rounded-2xl p-6 shadow-sm">
                        ...
                        <div className="space-y-4">
                            ...
                            <Field icon={<Phone className="w-4 h-4" />} label="Phone Number *" value={form.phone} onChange={(v) => setForm({ ...form, phone: v })} testid="checkout-phone" type="tel" />
                            <div>
                ...
                <aside className="lg:sticky lg:top-24 self-start">
                    <div className="bg-white border border-neutral-100 rounded-2xl p-6 shadow-sm">
                        ...
                        <button type="submit" disabled={loading} data-testid="checkout-place-order"
                            className="w-full mt-6 bg-brand-red hover:bg-brand-red-dark disabled:opacity-50 text-white rounded-full px-8 py-3.5 font-bold transition-colors">
                            {loading ? "Processing..." : `Place Order — Rs. ${total.toFixed(0)}`}
                        </button>
